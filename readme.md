...
Handout code is provided in [sloc.py](sloc.py) that includes definitions and tests for `is_blank` and `is_comment` helper functions. Complete these functions first.
